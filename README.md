...
- 업무 및 기록 관리는 Github Project로 칸반, 백로그 작성
- 데일리 스크럼, 스프린트 회의록, 기타 짜잘한 회의록, 팀 회고록, 멘토링 일지, 피어세션 등 노션에 작성 후 Github 위키에 갈무리
- 기획 및 디자인 피그마, 아키텍쳐 구조도, 핵심 기능 별 flow chart, API 문서 등 추후 작성
